...
export default {
  ...
  data() {
    return {
      erc20: '0xbd855a0C8066Ed7aD4892787b421c25e6e0902F6',
      selectedAddress: 'cosmos1pdvq7k50jpae8gm66dyuwrmhee6a40xqm8vv7z',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos1pdvq7k50jpae8gm66dyuwrmhee6a40xqm8vv7z')
